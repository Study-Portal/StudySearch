                            ...
                            <div class="mt-20">
                                <div>
                                    <a href="#" class="inline-flex space-x-4">
                                        <span class="rounded bg-rose-50 px-2.5 py-1 text-xs font-semibold text-rose-500 tracking-wide uppercase"> Study Search </span>
                  ...
                  <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                    <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd" />
                                ...
                                <div class="mt-6 sm:max-w-xl">
                                    <h1 class="text-4xl font-extrabold text-gray-900 tracking-tight sm:text-5xl">Giving students the support they need</h1>
                                    <p class="mt-6 text-xl text-gray-500">Search for what you need, whenever you need, all in one place with advanced filtering to your requirements.</p>
                                </div>

                               {{-- <div class="mt-4 sm:mt-0 sm:ml-3">
                                    <button type="button" class="block w-full rounded-md border border-transparent px-5 py-3 bg-rose-500 text-base font-medium text-white shadow hover:bg-rose-600 focus:outline-none focus:ring-2 focus:ring-rose-500 focus:ring-offset-2 sm:px-10">Get Started</button>
                                </div>--}}
            ...
            <footer class="mt-24 bg-gray-900 sm:mt-12">
                <div class="mx-auto max-w-md py-12 px-4 overflow-hidden sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8">
                    <div class="mt-8 flex justify-center space-x-6">
                        ...
                        <a href="https://github.com/Study-Portal/StudySearch" class="text-gray-400 hover:text-gray-300">
                    ...
                    <p class="mt-8 text-center text-base text-gray-400">&copy; {{now()->year}} Study Search, Inc. All rights reserved.</p>
                </div>
            </footer>
        </div>
